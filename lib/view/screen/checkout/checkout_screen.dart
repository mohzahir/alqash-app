...
import 'package:flutter_sixvalley_ecommerce/view/screen/checkout/widget/qibpay_method.dart';
    ...
    List<PaymentMethod> paymentMethods = [
      ...
      if (_digitalPayment! &&
          Provider.of<SplashProvider>(context, listen: false)
              ...
              .paymentMethods!
              .qibpay!)
        PaymentMethod('qibpay', Images.qibpay),
      if (_digitalPayment! &&
          Provider.of<SplashProvider>(context, listen: false)
              .configModel!
              .paymentMethods!
        ...
        return InkWell(
          onTap: () async {
            if (order.addressIndex == null && !widget.onlyDigital) {
              ...
              if (paymentMethods[order.paymentMethodIndex].name ==
                      'cash_on_delivery' &&
                  !widget.onlyDigital) {
              ...
              } else if (paymentMethods[order.paymentMethodIndex].name ==
                  'qibpay') {
                String x = PriceConverter.convertTotal(
                    context,
                    (_order +
                        widget.shippingFee -
                        widget.discount -
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (_) => PaymentScreen(
                              ...
                              orderNote: orderNote,
                              paymentMethod:
                                  paymentMethods[order.paymentMethodIndex].name,
                            )));
              }
            }
          },
                              ...
                              Expanded(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(children: [
                                        Text(
                                            '${getTranslated('qty', context)} -  ${Provider.of<CartProvider>(context, listen: false).cartList[index].quantity}',
                                            style: titilliumRegular.copyWith()),
                                      ]),
                                    ]),
                              ),
