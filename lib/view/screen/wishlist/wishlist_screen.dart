...
class WishListScreen extends StatefulWidget {
  const WishListScreen({Key? key, required this.wishListList}) : super(key: key);

  final List<WishLists> wishListList ;
...
class _WishListScreenState extends State<WishListScreen> {
  ...
  void initState() {
    ...
    // if (!isGuestMode) {
    //   Provider.of<WishListProvider>(context, listen: false).getWishListByCategory(
    //     context,
    //     widget.wishListList
    //   );
    // }
                          ...
                          ? widget.wishListList.isNotEmpty
                              ? RefreshIndicator(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemCount:
                                        widget.wishListList.length,
                                    itemBuilder: (context, index) =>
                                        WishListWidget(
                                      product:
                                          widget.wishListList[index].product,
                                      index: index,
                                    ),
                                  ),
                                )
