        ...
        Consumer<BannerProvider>(
          builder: (context, bannerProvider, child) {
            ...
            return SizedBox(
              width: width,
              height: width * 0.4,
              child: bannerProvider.mainBannerList != null ? bannerProvider.mainBannerList!.isNotEmpty ? Stack(
                fit: StackFit.expand,
                children: [
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: FadeInImage.assetNetwork(
                              ...
                              imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholder_3x1, fit: BoxFit.fill),
                            ),
                          ),
                        ),
                      );
                    ...
                    child: Row(
                      ...
                      children: bannerProvider.mainBannerList!.map((banner) {
                        ...
                        return TabPageSelectorIndicator(
                          backgroundColor: index == bannerProvider.currentIndex ? ColorResources.green : Colors.grey,
                          borderColor: index == bannerProvider.currentIndex ? ColorResources.green : Colors.grey,
                          size: 10,
                        );
                      }).toList(),
                    ),
