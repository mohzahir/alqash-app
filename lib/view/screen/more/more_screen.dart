...
import '../wishlist/favorit_category_save.dart';
...
class _MoreScreenState extends State<MoreScreen> {
  ...
  Widget build(BuildContext context) {
    print('==-=-=-=-=-=-=-');
    print(Provider.of<SplashProvider>(context,
                                  listen: false)
                              .configModel!
                              .cancellationPolicy!
                              .content);
            ...
            builder: (context, profile, child) {
              return Row(children: [
                ...
                InkWell(
                  onTap: () {
                    if (isGuestMode) {
                      showAnimatedDialog(context, const GuestDialog(),
                          isFlip: true);
                    } else {
                      ...
                      child: Row(
                        children: [
                          Icon(Directionality.of(context) == TextDirection.ltr
                              ? Icons.arrow_circle_left_outlined : Icons.arrow_circle_right_outlined,
                            ...
                            child: ListView(
                                ...
                                children: [
                                  ...
                                  SquareButton(
                                    ...
                                    navigateTo: const FavouritCategorySave(),
