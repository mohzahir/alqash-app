...
class AppConstants {
  static const String appName = 'Alqash';
  static const String appVersion = '14.0';
  static const String baseUrl = 'https://alqash.com';
  ...
  static const String getWishListCategoriesUri =
      '/api/v1/customer/category_wishlist';
  static const String createWishListCategoryUri =
      '/api/v1/customer/category_wishlist/add';
  ...
  static const String footerBannerUri =
      '/api/v1/banners?banner_type=footer_banner';
  static const String mainSectionBannerUri =
  ...
  static const String qibPayment = '/api/v1/initiate-payment';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(
        imageUrl: '',
        languageName: 'Urdo-Ararbic',
        countryCode: 'SA',
        languageCode: 'ur'),
    LanguageModel(
        imageUrl: '',
        languageName: 'Urdo-English',
        countryCode: 'US',
        languageCode: 'ro'),
  ];
}
